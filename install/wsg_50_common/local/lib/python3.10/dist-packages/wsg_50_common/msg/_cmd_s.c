...
bool wsg_50_common__msg__cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wsg_50_common.msg._cmd.Cmd", full_classname_dest, 26) == 0);
  }
  wsg_50_common__msg__Cmd * ros_message = _ros_message;
  {  // mode
...
PyObject * wsg_50_common__msg__cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wsg_50_common.msg._cmd");
