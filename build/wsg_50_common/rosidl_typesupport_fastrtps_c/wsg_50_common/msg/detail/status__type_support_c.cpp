...
#include "wsg_50_common/msg/detail/status__rosidl_typesupport_fastrtps_c.h"
...
using _Status__ros_msg_type = wsg_50_common__msg__Status;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: force_finger0
  {
    cdr << ros_message->force_finger0;
  }

  // Field name: force_finger1
  {
...
static uint32_t _Status__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wsg_50_common__msg__Status(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wsg_50_common__msg__Status;
    is_plain =
      (
...
static size_t _Status__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wsg_50_common__msg__Status(
