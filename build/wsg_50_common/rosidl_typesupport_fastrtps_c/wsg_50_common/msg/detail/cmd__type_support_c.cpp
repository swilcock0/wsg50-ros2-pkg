...
#include "wsg_50_common/msg/detail/cmd__rosidl_typesupport_fastrtps_c.h"
...
using _Cmd__ros_msg_type = wsg_50_common__msg__Cmd;
...
size_t get_serialized_size_wsg_50_common__msg__Cmd(
  const void * untyped_ros_message,
...
static uint32_t _Cmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wsg_50_common__msg__Cmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wsg_50_common
size_t max_serialized_size_wsg_50_common__msg__Cmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wsg_50_common__msg__Cmd;
    is_plain =
      (
...
static size_t _Cmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wsg_50_common__msg__Cmd(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wsg_50_common, msg, Cmd)() {
