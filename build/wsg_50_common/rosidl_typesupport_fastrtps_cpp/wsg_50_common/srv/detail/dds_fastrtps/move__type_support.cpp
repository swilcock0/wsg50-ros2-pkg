...
#include "wsg_50_common/srv/detail/move__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wsg_50_common::srv::Move_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wsg_50_common::srv::Move_Request & ros_message)
{
  // Member: width
  cdr >> ros_message.width;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wsg_50_common::srv::Move_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wsg_50_common::srv::Move_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wsg_50_common::srv::Move_Request *>(
    untyped_ros_message);
...
{
  return &wsg_50_common::srv::typesupport_fastrtps_cpp::_Move_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wsg_50_common, srv, Move_Request)() {
  return &wsg_50_common::srv::typesupport_fastrtps_cpp::_Move_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_wsg_50_common
cdr_serialize(
  const wsg_50_common::srv::Move_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: error
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wsg_50_common::srv::Move_Response & ros_message)
{
  // Member: error
  cdr >> ros_message.error;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = wsg_50_common::srv::Move_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wsg_50_common::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<wsg_50_common::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &wsg_50_common::srv::typesupport_fastrtps_cpp::_Move_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wsg_50_common, srv, Move_Response)() {
  return &wsg_50_common::srv::typesupport_fastrtps_cpp::_Move_Response__handle;
}
...
{
  return &wsg_50_common::srv::typesupport_fastrtps_cpp::_Move__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wsg_50_common, srv, Move)() {
  return &wsg_50_common::srv::typesupport_fastrtps_cpp::_Move__handle;
}
