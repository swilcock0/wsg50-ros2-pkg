...
static const _Cmd_type_support_symbol_names_t _Cmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wsg_50_common, msg, Cmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wsg_50_common, msg, Cmd)),
  }
};
...
{
  return &::wsg_50_common::msg::rosidl_typesupport_cpp::Cmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wsg_50_common, msg, Cmd)() {
  return get_message_type_support_handle<wsg_50_common::msg::Cmd>();
}
