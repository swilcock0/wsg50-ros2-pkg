...
static const _Incr_Request_type_support_symbol_names_t _Incr_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wsg_50_common, srv, Incr_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wsg_50_common, srv, Incr_Request)),
  }
};
...
{
  return &::wsg_50_common::srv::rosidl_typesupport_cpp::Incr_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wsg_50_common, srv, Incr_Request)() {
  return get_message_type_support_handle<wsg_50_common::srv::Incr_Request>();
}
...
static const _Incr_Response_type_support_symbol_names_t _Incr_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wsg_50_common, srv, Incr_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wsg_50_common, srv, Incr_Response)),
  }
};
...
{
  return &::wsg_50_common::srv::rosidl_typesupport_cpp::Incr_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wsg_50_common, srv, Incr_Response)() {
  return get_message_type_support_handle<wsg_50_common::srv::Incr_Response>();
}
...
static const _Incr_type_support_symbol_names_t _Incr_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wsg_50_common, srv, Incr)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wsg_50_common, srv, Incr)),
  }
};
...
{
  return &::wsg_50_common::srv::rosidl_typesupport_cpp::Incr_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, wsg_50_common, srv, Incr)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<wsg_50_common::srv::Incr>();
}
