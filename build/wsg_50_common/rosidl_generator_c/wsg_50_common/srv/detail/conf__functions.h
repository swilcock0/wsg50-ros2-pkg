...
#ifndef WSG_50_COMMON__SRV__DETAIL__CONF__FUNCTIONS_H_
#define WSG_50_COMMON__SRV__DETAIL__CONF__FUNCTIONS_H_
...
/// Create srv/Conf message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * wsg_50_common__srv__Conf_Request__init().
...
/// Destroy srv/Conf message.
/**
 * It calls
 * wsg_50_common__srv__Conf_Request__fini()
...
/// Check for srv/Conf message equality.
/**
...
/// Initialize array of srv/Conf messages.
/**
...
/// Finalize array of srv/Conf messages.
/**
 * It calls
 * wsg_50_common__srv__Conf_Request__fini()
...
/// Create array of srv/Conf messages.
/**
 * It allocates the memory for the array and calls
 * wsg_50_common__srv__Conf_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Conf messages.
/**
 * It calls
 * wsg_50_common__srv__Conf_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Conf message array equality.
/**
...
/// Copy an array of srv/Conf messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * wsg_50_common__srv__Conf_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_wsg_50_common
...
/**
 * It calls
 * wsg_50_common__srv__Conf_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_wsg_50_common
...
/**
 * It allocates the memory for the array and calls
 * wsg_50_common__srv__Conf_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_wsg_50_common
...
/**
 * It calls
 * wsg_50_common__srv__Conf_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WSG_50_COMMON__SRV__DETAIL__CONF__FUNCTIONS_H_
