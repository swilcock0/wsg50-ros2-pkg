...
class Metaclass_Move(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from wsg_50_common.srv import _move
...
class Move(metaclass=Metaclass_Move):
    from wsg_50_common.srv._move import Move_Request as Request
    from wsg_50_common.srv._move import Move_Response as Response
